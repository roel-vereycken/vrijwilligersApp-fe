      ...
      <form onSubmit={handleFormSubmit}>
        <Flex direction="column">
                <FormControl className="profileTextField" paddingTop="90px">
                  ...
                  <input className="profileInput" type="text" value={voornaam} onChange={e => setVoornaam(e.target.value)} />
                </FormControl>
                <FormControl className="profileTextField">
                  <FormLabel>Naam</FormLabel>
                  <input className="profileInput" type="text" value={naam} onChange={e => setNaam(e.target.value)} />
                </FormControl>
                <FormControl className="profileTextField">
                  <FormLabel>Emailadres</FormLabel>
                  <input className="profileInput" type="text" value={email} onChange={e => setEmail(e.target.value)}/>
                </FormControl>
                <FormControl className="profileTextField">
